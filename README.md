...
3. On _Ubuntu_, you'll need to install some packages to build Python properly:
      ```bash
      sudo apt -y install build-essential liblzma-dev libbz2-dev zlib1g zlib1g-dev libssl-dev libcrypt-dev libffi-dev libsqlite3-dev libncurses-dev libreadline-dev
      ```
